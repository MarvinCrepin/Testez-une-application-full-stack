...
public class SessionControllerITTest {
    ...
    public void findAllUnauthorized() throws Exception {
        mockMvc.perform(get("/api/session")
                        .header("Authorization", "JWT is not valid"))
                .andExpect(status().isUnauthorized())
                .andDo(print());
    }
    ...
    public void create() throws Exception {
        ...
        sessionDto.setName("Easy Level");
        sessionDto.setDescription("Beginner");
    ...
    public void updateBadRequest() throws Exception {
        SessionDto sessionDto = new SessionDto();
        sessionDto.setName("Hard level");
        sessionDto.setDescription("Hard level description");
        sessionDto.setDate(Date.from(Instant.now()));
        sessionDto.setTeacher_id(1L);
    ...
    public void participate() throws Exception {
        mockMvc.perform(post("/api/session/4/participate/4")
                        .header("Authorization", "Bearer " + jwt))
                .andExpect(status().isOk())
                .andDo(print());
    }
    ...
    @Test
    public void alreadyParticipate() throws Exception {
        mockMvc.perform(post("/api/session/4/participate/4")
                        .header("Authorization", "Bearer " + jwt))
                .andExpect(status().isBadRequest())
                .andDo(print());
    ...
    @Test
    public void participateBadRequest() throws Exception {
    ...
    @Test
    public void participateUnauthorized() throws Exception {
    ...
    public void noLongerParticipate() throws Exception {
        mockMvc.perform(delete("/api/session/4/participate/4")
                        .header("Authorization", "Bearer " + jwt))
                .andExpect(status().isOk())
                .andDo(print());
    }
    ...
    @Test
    public void noLongerParticipateNotFound() throws Exception {
    ...
    @Test
    public void noLongerParticipateButDidntParticipate() throws Exception {
    ...
    @Test
    public void noLongerParticipateBadRequest() throws Exception {
    ...
    @Test
    public void noLongerParticipateUnauthorized() throws Exception {
        mockMvc.perform(delete("/api/session/1/participate/1")
